/* biome-ignore-all lint/suspicious/noExplicitAny: Office.js proxy interception requires dynamic property access and variadic argument forwarding. */
/* global Excel */

import type { DirtyRange } from "../dirty-tracker";
import { getStableSheetId, resilientSync } from "./api";
      ...
      get(target, prop) {
        ...
        if (
          ...
          return (...args: any[]) => {
            ...
            const cached = worksheetProxies.get(sheet);
