...
export const modifyObjectTool = defineTool({
  ...
  description:
    ...
    "For charts, specify chartType, source (e.g. 'Sheet1!A1:D20' — must include sheet name prefix), and anchor. " +
    "For pivot tables, specify source, range, rows, columns, and values. " +
    "For update/delete: call get_all_objects first to get the correct object id — do NOT guess IDs.",
